...
export const saveProject=async p=>tx('readwrite',s=>s.put(validate(clone(p),{allowPriceOverrides:true})));
...
export const readProject=async id=>validate(await tx('readonly',s=>s.get(id)),{allowPriceOverrides:true});
